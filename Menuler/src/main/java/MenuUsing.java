 ...
 * @author burak
 */
public class MenuUsing extends javax.swing.JFrame {

    /**
     * Creates new form MenuUsing
     */
    public MenuUsing() {
        initComponents();
    }
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // Times New Roman yazi tipi ayarlama
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if (i == JFileChooser.APPROVE_OPTION) // kullanici okey basmış ise
        {
            ...
            try (Scanner scanner = new Scanner(new BufferedReader(new FileReader(file)))) {
                ...
                Logger.getLogger(MenuUsing.class.getName()).log(Level.SEVERE, null, ex);
            } 
        }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        {
            String path = fc.getSelectedFile().getPath(); // dosyanın dosya yolunu alıyoruz
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuUsing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
